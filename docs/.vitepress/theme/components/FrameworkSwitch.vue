...
<template>
  <div class="flex flex-1 justify-start gap-[48px]">
    <a
      ...
      :href="link.href"
      class="flex text-gray-700 relative font-secondary gap-[16px] text-[16px] leading-[24px] font-medium pb-[8px] bg-gradient-to-r bg-bottom bg-no-repeat duration-300 transition-all"
      :class="{
