...
async function getIcons() {
  ...
  const iconsObjectUnique = iconsObject.reduce((acc, curr) => {
    if (!iconsObjectSet.has(curr.interfaceName)) {
      ...
      acc[index].hasSecondaryStrokeColor |= curr.hasSecondaryStrokeColor;
      acc[index].hasSecondaryFillColor |= curr.hasSecondaryFillColor;
    }
    return acc;
  }, []);
...
async function generateIndex(iconsObjectUnique) {
  ...
  export var iconsMetadata = {${indexFileContent}} as const;
