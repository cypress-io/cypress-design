...
export interface MenuGroupEventsEmitted {
  /**
...
import MenuGroup from './_MenuGroup.vue'
import MenuLink from './_MenuLink.vue'
...
const $items = ref<(typeof MenuLink)[]>([])
const $groups = ref<(typeof MenuGroup)[]>([])
