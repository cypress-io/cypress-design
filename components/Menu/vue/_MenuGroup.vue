...
import { NavGroup, classes } from '@cypress-design/constants-menu'
import MenuGroupElements, {
  hasActiveItemRecursively,
  type MenuGroupEventsEmitted,
} from './_MenuGroupElements.vue'
...
const $groupElements = ref<typeof MenuGroupElements>()
...
const emit = defineEmits<MenuGroupEventsEmitted>()
