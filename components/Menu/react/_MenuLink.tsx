...
import { NavItemLink } from '@cypress-design/constants-menu'
...
export type MenuLinkComponentType = React.ElementType<{
  href: string
  className: string
...
export interface MenuLinkForward {
  setActiveMarkerPosition: () => void
}

export const MenuLink = React.forwardRef<MenuLinkForward, MenuLinkProps>(
