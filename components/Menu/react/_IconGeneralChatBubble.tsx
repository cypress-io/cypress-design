  ...
  return (
    ...
    >
      <path
        ...
        className={clsx(style['small-bubble'], 'icon-dark')}
      />
      <path
        fill="#BFC2D4"
        stroke="#1B1E2E"
        ...
        className={clsx(
          style['big-bubble'],
          'icon-light-stroke icon-dark-fill',
        )}
      />
      <circle
        cx="6"
        ...
        r="1"
        fill="#1B1E2E"
        className={clsx(style.dots, style.dots1, 'icon-dark-fill')}
      />
      <circle
        cx="9.5"
        cy="9"
        r="1"
        fill="#1B1E2E"
        className={clsx(style.dots, style.dots2, 'icon-dark-fill')}
      />
      <circle
        cx="13"
        cy="9"
        r="1"
        fill="#1B1E2E"
        className={clsx(style.dots, style.dots3, 'icon-dark-fill')}
      />
    </svg>
  )
}
