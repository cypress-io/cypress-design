...
import { FormGroup, palette } from '@frontend/design-system'
...
<Preview>
  <Story name="Contrast">
    {() => {
      ...
      const [backgroundColor, setBackgroundColor] = useState('gray1000')
      const keys = Object.keys(palette).filter(
        (k) => k.endsWith('0') || k.endsWith('1') || k.endsWith('2')
      )
      ...
      return (
        <div>
          <FormGroup
            ...
            description="grayA1 is white and grayA2 is black"
            style={{
              border: `2px solid ${palette.jade400}`,
              marginBottom: '48px',
            }}
          >
            <Select
              options={paletteList}
              defaultValue={{ value: 'gray1000', label: 'gray1000' }}
              onChange={onChange}
            />
          </FormGroup>
          <div>
